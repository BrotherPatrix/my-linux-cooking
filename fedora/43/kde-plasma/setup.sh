...
function install_ides {
	...
	wget -O /home/${USER}/kits/dev/eclipse.tar.gz https://ftp.halifax.rwth-aachen.de/eclipse/technology/epp/downloads/release/2025-09/R/eclipse-jee-2025-09-R-linux-gtk-x86_64.tar.gz
	wget -O /home/${USER}/kits/dev/idea.tar.gz https://download.jetbrains.com/idea/ideaIC-2025.2.4.tar.gz
...
function set_alacritty_config() {
cat > /home/${USER}/.config/alacritty/alacritty.toml <<'EOF'
[window]
opacity = 0.85
...
function install_terminal() {
	...
	log SUCC "Installed starship and configured alacritty terminal."
