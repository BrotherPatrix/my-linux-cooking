...
function set_remote() {
	...
	sudo dnf -y install openssh openssh-server
	...
	log SUCC "Updated XRDP access."

	log INFO "Reloading firewall..."
...
function set_mvns() {
	...
	wget -O /home/${USER}/.cooking/mvn-3.9.tar.gz https://dlcdn.apache.org/maven/maven-3/3.9.1/binaries/apache-maven-3.9.1-bin.tar.gz
